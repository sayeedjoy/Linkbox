  ...
  try {
    ...
    return NextResponse.json({
      ...
      entitlements: {
        ...
        browserBulkImportAllowed: entitlements.browserBulkImportAllowed,
        browserRealtimeSyncAllowed: entitlements.browserRealtimeSyncAllowed,
        bookmarkQuotaPerMonth: entitlements.bookmarkQuotaPerMonth,
