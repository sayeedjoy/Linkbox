...
export function BookmarkSortHeader({
  ...
  return (
    <div className="hidden sm:grid grid-cols-[1fr_auto] gap-4 items-center px-4 py-2 text-xs font-medium uppercase tracking-wide text-muted-foreground">
      <div className="flex flex-wrap items-center gap-x-4 gap-y-1 min-w-0">
        ...
        <div className="flex flex-wrap items-center gap-x-2 gap-y-1 text-muted-foreground/60 font-normal normal-case">
